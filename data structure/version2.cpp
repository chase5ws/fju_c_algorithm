...
int main()
{
    ...
    cout << "Rember cover the same name with the file and same Folder" << endl;
    ifstream ifs;
    ifs.open("input(example).txt");
    char buffer[sizeof(ifs)] = {0};
    ...
    else
    {
        ...
        cout << "Check the list : " << buffer << endl;
        ifs.close();
    }
    int count = 0;
    int answer = 1;
    ...
    // cout << "the long of the linklist: " << count << " ('x' is : " << x_number << endl;
    // cout << "the get_count is  " << get_count << endl;
    cout << "Magic number : " << answer << endl;
    return 0;
}
